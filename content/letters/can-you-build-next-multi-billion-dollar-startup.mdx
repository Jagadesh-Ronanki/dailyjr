---
title: Can you build next multi billion dollar startup?
...
image: "./assets/can-you-build-next-multi-billion-dollar-startup/startup.png"
imageDark: "./assets/can-you-build-next-multi-billion-dollar-startup/startup-dark.png"
published: true
...
<div style={{ paddingTop: '1rem' }} className="pt-2 flex justify-center items-center">
  <img
    width="70%"
    src="./assets/can-you-build-next-multi-billion-dollar-startup/the-execution-equation.png"
  />
</div>
...
<div style={{ paddingTop: '1rem' }} className="pt-2 flex justify-center items-center">
  <img
    width="70%"
    src="./assets/can-you-build-next-multi-billion-dollar-startup/the-entrepreneurial-compass.png"
  />
</div>
